        ...
        {data?.allTestimonial?.map((data) => {
          return (
            <SwiperSlide key={data._id}>
              <Card style={{ width: "auto", minHeight:"20rem" ,maxHeight:"25rem" }}>
                <Card.Img variant="top" src={data.image} style={{backgroundSize:"cover",backgroundPosition:"center",minHeight:"13rem",maxHeight:"13rem"}} />
                <Card.Body>
