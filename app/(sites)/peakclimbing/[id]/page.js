      ...
      <div className={styles.left}>
        ...
        <div>
          <div style={{ textAlign: "justify" }}>
            <h3>Trip OverView</h3>
            <p>{data?.peakclimbing?.overview}</p>
          </div>
          <div>
          ...
          <div style={{ textAlign: "justify" }}>
            ...
            <p>{data?.peakclimbing?.comprehensiveGuide}</p>
          </div>
        ...
        <div>
          ...
          <div style={{ width: "100%", height: "400px", overflow: "scroll" }}>
            <img src={data?.peakclimbing?.map} width={"100%"} />
          </div>
        </div>
        <div>
          <Table striped bordered hover>
        ...
        <div>
          ...
          <p>{data?.peakclimbing?.experienceRequired}</p>
        </div>
        <div>
          <h5>Best Time To Travel</h5>
          <p>{data?.peakclimbing?.bestTimeToTravel}</p>
        </div>
        <div>
          <h5>Visa And Entry Procedures</h5>
          <p>{data?.peakclimbing?.visaAndEntryProcedure}</p>
        </div>
        <div>
          <h5>Our peakclimbingking Guides/Leaders </h5>
