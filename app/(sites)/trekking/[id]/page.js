      ...
      <div className={styles.left}>    
        ...
        <div>
          ...
          <div style={{ textAlign: "justify" }}>
            ...
            <p>{data?.trek?.comprehensiveGuide}</p>
          </div>
        ...
        <div>
          ...
          <div style={{ width: "100%", height: "400px", overflow: "scroll" }}>
            <img src={data?.trek?.map} width={"100%"} />
          </div>
        </div>
        <div>
          <Table striped bordered hover>
        ...
        <div>
          ...
          <p>{data?.trek?.experienceRequired}</p>
        </div>
        <div>
          <h5>Best Time To Travel</h5>
          <p>{data?.trek?.bestTimeToTravel}</p>
        </div>
        <div>
          <h5>Visa And Entry Procedures</h5>
          <p>{data?.trek?.visaAndEntryProcedure}</p>
        </div>
        <div>
